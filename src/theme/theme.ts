...
const theme = {
  light: {
    ...
    '--background-secondary': `rgb(${colors['--white']}, ${opacities['--12']})`,
    '--background-destructive': `rgb(${colors['--red-300']})`,
    '--border-primary': `rgba(${colors['--black']}, ${opacities['--12']})`,
    '--border-secondary': `rgba(${colors['--black']}, ${opacities['--56']})`,
    '--border-shadow': `rgba(${colors['--black']}, ${opacities['--10']})`,
  },
  dark: {
    ...colors,
    ...
    '--background-secondary': `rgb(${colors['--black']}, ${opacities['--56']})`,
    '--background-destructive': `rgb(${colors['--red-500']})`,
    '--border-primary': `rgba(${colors['--white']}, ${opacities['--12']})`,
    '--border-secondary': `rgba(${colors['--white']}, ${opacities['--56']})`,
    '--border-shadow': `rgba(${colors['--grey-700']}, ${opacities['--10']})`,
  },
} as const;
